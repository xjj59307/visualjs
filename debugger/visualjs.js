module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c17 = "next",
        peg$c18 = "\"next\"",
        peg$c19 = "foreach_next",
        peg$c20 = "\"foreach_next\"",
        peg$c21 = "exec",
        peg$c22 = "\"exec\"",
        peg$c23 = "when",
        peg$c24 = "\"when\"",
        ...
        peg$c31 = "}",
        peg$c32 = "\"}\"",
        peg$c33 = function(name, exec_clauses) {
            return {
              type: 'pattern',
              name: name,
        ...
        peg$c37 = function(name, condition) {
            return {
              type: 'exec_clause',
              name: name,
              condition: condition 
        ...
        peg$c48 = function(name, action_clauses) {
            return {
              type: 'action',
              name: name,
        ...
        peg$c50 = function(node, attributes) {
            return {
              type: 'create_clause',
              node: node,
        ...
        peg$c51 = "=",
        peg$c52 = "\"=\"",
        peg$c53 = function(name, node_type) {
            return {
        ...
        peg$c55 = function(object, environment) {
    ...
    function peg$parseforeach_next_token() {
      var s0, s1, s2, s3;
    ...
    function peg$parsenext_clause() {
      ...
      s0 = peg$parsenext_object_clause();
      if (s0 === null) {
        s0 = peg$parseforeach_clause();
      }

      return s0;
    }

    function peg$parsenext_object_clause() {
    ...
    function peg$parseforeach_clause() {
      var s0, s1, s2, s3, s4, s5, s6, s7, s8;

      s0 = peg$currPos;
      s1 = peg$parseforeach_next_token();
      if (s1 !== null) {
        s2 = peg$parse__();
        if (s2 !== null) {
          if (input.charCodeAt(peg$currPos) === 40) {
          ...
          if (s3 !== null) {
            s4 = peg$parse__();
            if (s4 !== null) {
              s5 = peg$parseassignment_expressions();
              if (s5 === null) {
                s5 = peg$c3;
              }
              if (s5 !== null) {
